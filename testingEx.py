# -*- coding: utf-8 -*-
"""
Created on Fri Feb  1 06:38:58 2019

@author: MUHAMAD SATRIA ADHI
"""

#program untuk menguji akurasi data set dengan Query Expansion

import pandas as pd
data = pd.read_csv('./data_set/1tweetTestEx.csv')



import pandas as pd
raw_data2 = pd.DataFrame()
tmp=pd.read_csv('./data_set/1tweetTrainExLabel.csv')
...
tmp = pd.read_csv('./data_set/1tweetTestExLabel.csv')
