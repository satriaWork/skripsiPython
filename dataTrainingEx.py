# -*- coding: utf-8 -*-
"""
Created on Thu Jan 31 18:45:01 2019

@author: MUHAMAD SATRIA ADHI
"""

#program untuk preprocessing data training dengan Query Expansion
...
dt.to_csv("./data_set/1tweetTrainEx.csv",  encoding='utf-8', index=False)